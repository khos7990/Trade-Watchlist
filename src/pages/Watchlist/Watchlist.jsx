    ...
    return (
      <div>
        <AppBar>
          ...
          <Typography className="navText" variant="h6" align="center">
            {" "}
            Welcome to Watchlist
          </Typography>
          <Link to={"/chart/inflation"}>
            {" "}
            <Typography variant="h6">
              IMPORTANT!!!! See the Rise of Inflation
            </Typography>{" "}
          </Link>
        </AppBar>
        ...
        <DisplayAllPairs
          ...
          clickForChart={this.props.handleClickForChart}
          pairDB={this.state.pairDB}
